            ...
            <div>
                <main className="">
                    <div className="hero" style={{
                        backgroundImage: `url(/images/${OrientalCategory.category_photo})`,
                        minHeight: '450px'
                    }}>

                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                                <h1 className="mb-5 text-5xl text-white font-bold">{OrientalCategory.category_name}</h1>
                            </div>
                        </div>
                    </div>
                </main>
                <div className="container mx-auto px-4 py-8">
                    <div className="flex justify-center pt-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-40 gap-y-20">
                            {OrientalCategory.dishes.map((dish) => (
