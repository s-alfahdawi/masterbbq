...
export default function BoxMeal() {
    ...
    const ColdApeetizersCategory = menu.find((category) => category.category_id === "5");

    if (ColdApeetizersCategory) {
        return (
            <div>
                <div className="">
                    <div className="hero"
                         style={{backgroundImage: `url(/images/${ColdApeetizersCategory.category_photo})`, minHeight: '450px'}}>
                        <div className=""></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                                <h1 className="mb-5 text-5xl text-white font-bold">{ColdApeetizersCategory.category_name}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="container mx-auto px-4 py-8">
                    <div className="flex justify-center pt-10">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-20 md:gap-y-10 gap-y-20">
                            {ColdApeetizersCategory.dishes.map((dish) => (
