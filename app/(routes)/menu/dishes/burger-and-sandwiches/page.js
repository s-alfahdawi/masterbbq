...
//             <div>
//                 <main className="">
//                     <div className="hero" style={{ backgroundImage: `url(${BurgerCategory.category_photo})`, minHeight: "450px" }}>
...
//                                         <Image src={dish.photo} alt={dish.name} className="rounded-xl card-img" />
//                                     </figure>
...
//                             <Image src={selectedImage} alt="Selected" className="w-full h-auto" />
//                         </motion.div>
//                     </div>
//                 )}
//             </div>
