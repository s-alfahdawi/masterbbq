...
function Homemenu() {
    ...
    return (
        <div className="swiper-container-main">
            ...
            <div  className="carousel carousel-end  max-w-full w-full min-w-md p-4 space-x-4 rounded-box">
                {categories.map((category, index) => (
                    <div key={index} className="carousel-item relative hover:scale-[1.05]">
