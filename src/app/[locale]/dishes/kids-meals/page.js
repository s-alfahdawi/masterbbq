...
//     const keys_s = ['1']
//     const KidsMealsCategory = menu.find((category) => category.category_id === "18");
...
//                     <div className="">
//                         <div className="hero"
//                              style={{backgroundImage: `url(${s(`${keyss}.photo`)})`, minHeight: '450px'}}>
//                             <div className=""></div>
//                             <div className="hero-content text-center text-neutral-content">
//                                 <div className="max-w-md">
//                                     <h1 className="mb-5 text-5xl text-white font-bold">{s(`${keyss}.name`)}</h1>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
...
//                     <div
//                         className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 lg:gap-x-40 gap-x-30 md:gap-x-20 gap-y-10">
//                         {keys.map((key) => (
...
//
//                                     <img src={t(`${key}.photo`)} alt={t(`${key}.name`)}
...
export default function KidsMeals() {
    ...
    const KidsMealsCategory = menu.find((category) => category.category_id === categoryKey);
    const [selectedImage, setSelectedImage] = useState(null);
    const [isOpen, setIsOpen] = useState(false);
    ...
    return (
        <div>
            <div className="hero" style={{backgroundImage: `url(${s(`${categoryKey}.category_photo`)})`, minHeight: '450px'}}>
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-5xl text-white font-bold">{s(`${categoryKey}.category_name`)}</h1>
                    </div>
                </div>
            </div>
            <div className="container mx-auto px-4 py-8">
